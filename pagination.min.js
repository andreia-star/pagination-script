...
function startPagination(a) {
    ...
    if (currentPageNo > 1) {
        if (currentPageNo == 2) {
            ...
            if (currentPage == 'page') {
                b += '<a class="page-num page-prev" href="#" onclick="getPage(' + c + ');return false" aria-label="Página anterior" title="Página anterior"></a>'
            } else {
    ...
    if (currentPageNo < lastPageNo) {
        if (currentPage == 'page') {
            b += '<a class="page-num page-next" href="#" onclick="getPage(' + e + ');return false" aria-label="Próxima página" title="Próxima página"></a>'
        } else {
