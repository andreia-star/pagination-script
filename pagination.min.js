...
function findPostDate(a) {
  ...
  // 🔁 Em vez de redirecionar, altera a URL sem recarregar
  window.history.pushState({}, "", d);
  // Se quiser forçar recarregamento apenas em navegadores sem suporte, use:
  // if (!window.history.pushState) location.href = d;
}
